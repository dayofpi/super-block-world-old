...
public class HammerItem extends Item {
   ...
   public boolean postMine(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity miner) {
      ...
      if (state.getBlock() instanceof BrickBlock) {
         world.playSound(null, miner.getX(), miner.getY(), miner.getZ(), SoundList.BREAK, SoundCategory.NEUTRAL, 0.5F, 1.0F / (world.getRandom().nextFloat() * 0.4F + 0.8F));
      }
   ...
   public boolean canRepair(ItemStack stack, ItemStack ingredient) {
      return ingredient.isOf(ItemList.BRONZE_INGOT) || super.canRepair(stack, ingredient);
   }
   ...
   public boolean isSuitableFor(BlockState state) {
      return state.getBlock() instanceof BrickBlock;
   }

   public float getMiningSpeedMultiplier(ItemStack stack, BlockState state) {
      return state.getBlock() instanceof BrickBlock ? 12.0F : 1.0F;
   }
