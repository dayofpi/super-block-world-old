...
public class BooLanternBlock extends BlockWithEntity {
    ...
    protected static final VoxelShape SHAPE = Block.createCuboidShape(3.0D, 0.0D, 3.0D, 11.0D, 10.0D, 11.0D);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, BlockEntityList.BOO_LANTERN, BooLanternBE::tick);
    }
