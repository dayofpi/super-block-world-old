...
public class Sounds {
    protected static final Identifier ITEM_IN_ID = new Identifier(Main.MOD_ID, "item_in");
    protected static final Identifier ITEM_OUT_ID = new Identifier(Main.MOD_ID, "item_out");
