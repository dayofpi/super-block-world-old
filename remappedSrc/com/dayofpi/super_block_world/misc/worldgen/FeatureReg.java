...
public class FeatureReg {
    public static final ConfiguredFeature<TreeFeatureConfig, ?> AMANITA = Feature.TREE.configure((new TreeFeatureConfig.Builder(
            ...
            new SimpleBlockStateProvider(States.AMANITA_SAPLING), new LargeOakFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().dirtProvider(new SimpleBlockStateProvider(BlockTypes.TOADSTOOL_GRASS.getDefaultState())).build());
    ...
    public static final class States {
        ...
        private static final BlockState AMANITA_SAPLING = BlockTypes.AMANITA_SAPLING.getDefaultState();
        private static final BlockState AMANITA_LOG = BlockTypes.AMANITA_LOG.getDefaultState();
    }
}
