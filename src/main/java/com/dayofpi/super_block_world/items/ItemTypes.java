...
public class ItemTypes {
    ...
    public static final Item YOSHI_FRUIT = new Item(new FabricItemSettings().food(FoodComponents.YOSHI_FRUIT).group(Main.MOD_GROUP));
    public static final Item SUPER_MUSHROOM = new Item(new FabricItemSettings().food(FoodComponents.SUPER_MUSHROOM).maxCount(16).group(Main.MOD_GROUP));
    public static final Item POISON_MUSHROOM = new Item(new FabricItemSettings().food(FoodComponents.POISON_MUSHROOM).maxCount(16).group(Main.MOD_GROUP));
    ...
    public static final Item BUZZY_BEETLE_SPAWN_EGG = new SpawnEggItem(EntityTypes.BUZZY_BEETLE, 16777215, 16777215, new FabricItemSettings().group(Main.MOD_GROUP));
    public static final Item SPIKE_TOP_SPAWN_EGG = new SpawnEggItem(EntityTypes.SPIKE_TOP, 16777215, 16777215, new FabricItemSettings().group(Main.MOD_GROUP));
    ...
    public static void registerBlockItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "pink_mushroom_cap"), new BlockItem(BlockTypes.PINK_MUSHROOM_CAP, new FabricItemSettings().group(Main.MOD_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "purple_mushroom_cap"), new BlockItem(BlockTypes.PURPLE_MUSHROOM_CAP, new FabricItemSettings().group(Main.MOD_GROUP)));
