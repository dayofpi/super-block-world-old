...
public class FireFlowerItem extends Item {
   ...
   public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
      ...
      world.playSound(null, user.getX(), user.getY(), user.getZ(), NewSoundList.ITEM_FIRE_FLOWER_SHOOT, SoundCategory.NEUTRAL, 0.5F, 1.0F / (world.getRandom().nextFloat() * 0.4F + 0.8F));
