...
public class BlockTypes {
    ...
    public static final Block DONUT_BLOCK = new DonutBlock(FabricBlockSettings.copyOf(TOADSTOOL_SOIL).sounds(BlockSoundGroup.DRIPSTONE_BLOCK).strength(0.1F).nonOpaque());
