...
public class ToadstoolFarmland extends FarmlandBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        return !this.getDefaultState().canPlaceAt(ctx.getWorld(), ctx.getBlockPos()) ? BlockTypes.TOADSTOOL_SOIL.getDefaultState() : super.getPlacementState(ctx);
    }
    ...
    public static void setToSoil(BlockState state, World world, BlockPos pos) {
        world.setBlockState(pos, pushEntitiesUpBeforeBlockChange(state, BlockTypes.TOADSTOOL_SOIL.getDefaultState(), world, pos));
    }
