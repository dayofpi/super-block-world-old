...
public class WoodBlock extends PillarBlock {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        BlockState stripResult = BlockList.STRIPPED_AMANITA_LOG.getDefaultState();
        if (state.isOf(BlockList.AMANITA_WOOD)) {
            stripResult = BlockList.STRIPPED_AMANITA_WOOD.getDefaultState();
        }
