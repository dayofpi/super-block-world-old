...
public class ToadstoolGrassBlock extends ToadstoolSoilBlock implements Fertilizable {
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        ...
        BlockState blockState = BlockList.TOADSTOOL_GRASS.getDefaultState();
        ...
        for(int i = 0; i < 128; ++i) {
            ...
            if (blockState2.isAir()) {
                ...
                if (random.nextInt(8) == 0) {
                    ...
                    configuredFeature2 = ((RandomPatchFeatureConfig)((ConfiguredFeature)list.get(0)).getConfig()).feature().get();
                } else {
