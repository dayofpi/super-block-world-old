...
import com.dayofpi.super_block_world.core.registry.ModPlants;
...
public class BlockClient {
    public static void setRenderLayers() {
        ColorProviderRegistry.BLOCK.register((state, view, pos, tintIndex) ->
                ...
                BlockReg.TOADSTOOL_GRASS);
        ColorProviderRegistry.BLOCK.register((state, view, pos, tintIndex) ->
                        view != null && pos != null ? BiomeColors.getFoliageColor(view, pos) : FoliageColors.getColor(0.5D, 1.0D),
                BlockReg.AMANITA_LEAVES, BlockReg.FRUITING_AMANITA_LEAVES);
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> 7067428, BlockReg.TOADSTOOL_GRASS);
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> 7067428, BlockReg.AMANITA_LEAVES, BlockReg.FRUITING_AMANITA_LEAVES);

        BlockEntityRendererRegistry.INSTANCE.register(BlockEntities.MOD_SIGN, ModSignRender::new);

        BlockRenderLayerMap.INSTANCE.putBlock(BlockReg.TOADSTOOL_GRASS, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockReg.AMANITA_LEAVES, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockReg.FRUITING_AMANITA_LEAVES, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockReg.STONE_TORCH, RenderLayer.getCutout());
