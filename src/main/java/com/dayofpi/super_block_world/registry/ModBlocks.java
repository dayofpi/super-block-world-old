...
import com.dayofpi.super_block_world.common.utility.blocktypes.ModFluidBlock;
...
import com.dayofpi.super_block_world.common.utility.blocktypes.ModFallingBlock;
import com.dayofpi.super_block_world.common.utility.ModSignType;
import com.dayofpi.super_block_world.common.utility.blocktypes.ModStairsBlock;
...
public class ModBlocks {
    ...
    public static final Block FRUITING_AMANITA_LEAVES = new LeavesBlock(FabricBlockSettings.of(Material.LEAVES).strength(0.2F).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning(ModBlocks::canSpawnOnLeaves).suffocates(ModBlocks::never).blockVision(ModBlocks::never));
