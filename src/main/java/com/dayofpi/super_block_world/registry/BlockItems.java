...
public class BlockItems {
    public static void registerBlockItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "toadstool_path"), new BlockItem(BlockRegistry.TOADSTOOL_PATH, new FabricItemSettings().group(Main.MOD_GROUP)));
        ...
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "question_block"), new BlockItem(BlockRegistry.QUESTION_BLOCK, new FabricItemSettings().group(Main.MOD_GROUP)));
        ...
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "amanita_planks"), new BlockItem(BlockRegistry.AMANITA_PLANKS, new FabricItemSettings().group(Main.MOD_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "amanita_slab"), new BlockItem(BlockRegistry.AMANITA_SLAB, new FabricItemSettings().group(Main.MOD_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "amanita_stairs"), new BlockItem(BlockRegistry.AMANITA_STAIRS, new FabricItemSettings().group(Main.MOD_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "amanita_leaves"), new BlockItem(BlockRegistry.AMANITA_LEAVES, new FabricItemSettings().group(Main.MOD_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "fruiting_amanita_leaves"), new BlockItem(BlockRegistry.FRUITING_AMANITA_LEAVES, new FabricItemSettings().group(Main.MOD_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "amanita_sapling"), new BlockItem(PlantRegistry.AMANITA_SAPLING, new FabricItemSettings().group(Main.MOD_GROUP)));
        ...
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "yellow_mushroom"), new BlockItem(PlantRegistry.YELLOW_MUSHROOM, new FabricItemSettings().group(Main.MOD_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "green_mushroom"), new BlockItem(PlantRegistry.GREEN_MUSHROOM, new FabricItemSettings().group(Main.MOD_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, "yellow_flowerbed"), new BlockItem(PlantRegistry.YELLOW_FLOWERBED, new FabricItemSettings().group(Main.MOD_GROUP)));
