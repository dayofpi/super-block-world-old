...
public class BlockReg {
    ...
    public static final Block VANILLATE_CRUMBS = new ModFallingBlock(FabricBlockSettings.copyOf(VANILLATE).mapColor(MapColor.WHITE_GRAY));
    ...
    public static void registerBlocks() {
        ...
        Registry.register(Registry.BLOCK, new Identifier(Main.MOD_ID, "vanillate_crumbs"), VANILLATE_CRUMBS);
