...
public class ModFeatures {
    public static final ConfiguredFeature<TreeFeatureConfig, ?> AMANITA = Feature.TREE.configure((new TreeFeatureConfig.Builder(
            ...
            new SimpleBlockStateProvider(States.AMANITA_SAPLING), new LargeOakFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().dirtProvider(new SimpleBlockStateProvider(ModBlocks.TOADSTOOL_GRASS.getDefaultState())).build());
    ...
    public static final class States {
        private static final BlockState YELLOW_MUSHROOM_CAP = ModBlocks.YELLOW_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
        private static final BlockState GREEN_MUSHROOM_CAP = ModBlocks.GREEN_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
