...
public class CustomMineshaftGenerator {
    ...
    private static CustomMineshaftGenerator.MineshaftPart pickPiece(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, @Nullable Direction orientation, int chainLength, CustomMineshaftFeature.Type type) {
        int i = random.nextInt(100);
        BlockBox blockBox2;
        if (i >= 80) {
            blockBox2 = CustomMineshaftGenerator.MineshaftCrossing.getBoundingBox(structurePiecesHolder, random, x, y, z, orientation);
            if (blockBox2 != null) {
                return new CustomMineshaftGenerator.MineshaftCrossing(chainLength, blockBox2, orientation, type);
            }
        } else if (i >= 70) {
            blockBox2 = CustomMineshaftGenerator.MineshaftStairs.getBoundingBox(structurePiecesHolder, random, x, y, z, orientation);
            if (blockBox2 != null) {
                return new CustomMineshaftGenerator.MineshaftStairs(chainLength, blockBox2, orientation, type);
            }
        } else {
            blockBox2 = CustomMineshaftGenerator.MineshaftCorridor.getBoundingBox(structurePiecesHolder, random, x, y, z, orientation);
            if (blockBox2 != null) {
                return new CustomMineshaftGenerator.MineshaftCorridor(chainLength, random, blockBox2, orientation, type);
            }
        }
    ...
    static CustomMineshaftGenerator.MineshaftPart pieceGenerator(StructurePiece start, StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
        if (chainLength > 8) {
            return null;
        } else if (Math.abs(x - start.getBoundingBox().getMinX()) <= 80 && Math.abs(z - start.getBoundingBox().getMinZ()) <= 80) {
            CustomMineshaftFeature.Type type = ((CustomMineshaftGenerator.MineshaftPart)start).mineshaftType;
            CustomMineshaftGenerator.MineshaftPart mineshaftPart = pickPiece(structurePiecesHolder, random, x, y, z, orientation, chainLength + 1, type);
    ...
    public static class MineshaftCrossing extends CustomMineshaftGenerator.MineshaftPart {
        ...
        public MineshaftCrossing(ServerWorld world, NbtCompound nbt) {
            super(ReplacementFeatureList.MINESHAFT_CROSSING, nbt);
        ...
        public MineshaftCrossing(int chainLength, BlockBox boundingBox, @Nullable Direction orientation, CustomMineshaftFeature.Type type) {
            super(ReplacementFeatureList.MINESHAFT_CROSSING, chainLength, type, boundingBox);
        ...
        public void fillOpenings(StructurePiece start, StructurePiecesHolder structurePiecesHolder, Random random) {
            ...
            switch(this.direction) {
                case NORTH:
                default:
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() + 1, this.boundingBox.getMinY(), this.boundingBox.getMinZ() - 1, Direction.NORTH, i);
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY(), this.boundingBox.getMinZ() + 1, Direction.WEST, i);
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY(), this.boundingBox.getMinZ() + 1, Direction.EAST, i);
                    break;
                case SOUTH:
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() + 1, this.boundingBox.getMinY(), this.boundingBox.getMaxZ() + 1, Direction.SOUTH, i);
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY(), this.boundingBox.getMinZ() + 1, Direction.WEST, i);
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY(), this.boundingBox.getMinZ() + 1, Direction.EAST, i);
                    break;
                case WEST:
            ...
            if (this.twoFloors) {
                if (random.nextBoolean()) {
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() + 1, this.boundingBox.getMinY() + 3 + 1, this.boundingBox.getMinZ() - 1, Direction.NORTH, i);
                }

                if (random.nextBoolean()) {
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY() + 3 + 1, this.boundingBox.getMinZ() + 1, Direction.WEST, i);
                }

                if (random.nextBoolean()) {
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY() + 3 + 1, this.boundingBox.getMinZ() + 1, Direction.EAST, i);
                }

                if (random.nextBoolean()) {
                    CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() + 1, this.boundingBox.getMinY() + 3 + 1, this.boundingBox.getMaxZ() + 1, Direction.SOUTH, i);
                }
            }
    ...
    public static class MineshaftStairs extends CustomMineshaftGenerator.MineshaftPart {
        public MineshaftStairs(int chainLength, BlockBox boundingBox, Direction orientation, CustomMineshaftFeature.Type type) {
            super(ReplacementFeatureList.MINESHAFT_STAIRS, chainLength, type, boundingBox);
            this.setOrientation(orientation);
        }

        public MineshaftStairs(ServerWorld world, NbtCompound nbt) {
            super(ReplacementFeatureList.MINESHAFT_STAIRS, nbt);
        }
        ...
        public void fillOpenings(StructurePiece start, StructurePiecesHolder structurePiecesHolder, Random random) {
            ...
            if (direction != null) {
                switch(direction) {
                    case NORTH:
                    default:
                        CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX(), this.boundingBox.getMinY(), this.boundingBox.getMinZ() - 1, Direction.NORTH, i);
                        break;
                    case SOUTH:
                        CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX(), this.boundingBox.getMinY(), this.boundingBox.getMaxZ() + 1, Direction.SOUTH, i);
                        break;
                    case WEST:
                        CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY(), this.boundingBox.getMinZ(), Direction.WEST, i);
                        break;
                    case EAST:
                        CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY(), this.boundingBox.getMinZ(), Direction.EAST, i);
                }
            }
    ...
    public static class MineshaftCorridor extends CustomMineshaftGenerator.MineshaftPart {
        ...
        public MineshaftCorridor(ServerWorld world, NbtCompound nbt) {
            super(ReplacementFeatureList.MINESHAFT_CORRIDOR, nbt);
        ...
        public MineshaftCorridor(int chainLength, Random random, BlockBox boundingBox, Direction orientation, CustomMineshaftFeature.Type type) {
            super(ReplacementFeatureList.MINESHAFT_CORRIDOR, chainLength, type, boundingBox);
            this.setOrientation(orientation);
        ...
        public void fillOpenings(StructurePiece start, StructurePiecesHolder structurePiecesHolder, Random random) {
            ...
            if (direction != null) {
                switch(direction) {
                    ...
                    default:
                        if (j <= 1) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX(), this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMinZ() - 1, direction, i);
                        } else if (j == 2) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMinZ(), Direction.WEST, i);
                        } else {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMinZ(), Direction.EAST, i);
                        }
                        break;
                    case SOUTH:
                        if (j <= 1) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX(), this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMaxZ() + 1, direction, i);
                        } else if (j == 2) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMaxZ() - 3, Direction.WEST, i);
                        } else {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMaxZ() - 3, Direction.EAST, i);
                        }
                        break;
                    case WEST:
                        if (j <= 1) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMinZ(), direction, i);
                        } else if (j == 2) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX(), this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMinZ() - 1, Direction.NORTH, i);
                        } else {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX(), this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMaxZ() + 1, Direction.SOUTH, i);
                        }
                        break;
                    case EAST:
                        if (j <= 1) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMinZ(), direction, i);
                        } else if (j == 2) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() - 3, this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMinZ() - 1, Direction.NORTH, i);
                        } else {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() - 3, this.boundingBox.getMinY() - 1 + random.nextInt(3), this.boundingBox.getMaxZ() + 1, Direction.SOUTH, i);
                        }
                }
            }
            ...
            if (i < 8) {
                ...
                if (direction != Direction.NORTH && direction != Direction.SOUTH) {
                    for(k = this.boundingBox.getMinX() + 3; k + 3 <= this.boundingBox.getMaxX(); k += 5) {
                        l = random.nextInt(5);
                        if (l == 0) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, k, this.boundingBox.getMinY(), this.boundingBox.getMinZ() - 1, Direction.NORTH, i + 1);
                        } else if (l == 1) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, k, this.boundingBox.getMinY(), this.boundingBox.getMaxZ() + 1, Direction.SOUTH, i + 1);
                        }
                    }
                } else {
                    for(k = this.boundingBox.getMinZ() + 3; k + 3 <= this.boundingBox.getMaxZ(); k += 5) {
                        l = random.nextInt(5);
                        if (l == 0) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY(), k, Direction.WEST, i + 1);
                        } else if (l == 1) {
                            CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY(), k, Direction.EAST, i + 1);
                        }
                    }
                }
            }
    ...
    private abstract static class MineshaftPart extends StructurePiece {
        protected CustomMineshaftFeature.Type mineshaftType;

        public MineshaftPart(StructurePieceType structurePieceType, int chainLength, CustomMineshaftFeature.Type type, BlockBox box) {
        ...
        public MineshaftPart(StructurePieceType structurePieceType, NbtCompound nbtCompound) {
            ...
            this.mineshaftType = CustomMineshaftFeature.Type.byIndex(nbtCompound.getInt("MST"));
        }
    ...
    public static class MineshaftRoom extends CustomMineshaftGenerator.MineshaftPart {
        ...
        public MineshaftRoom(int chainLength, Random random, int x, int z, CustomMineshaftFeature.Type type) {
            super(ReplacementFeatureList.MINESHAFT_ROOM, chainLength, type, new BlockBox(x, 50, z, x + 7 + random.nextInt(6), 54 + random.nextInt(6), z + 7 + random.nextInt(6)));
            this.mineshaftType = type;
        }

        public MineshaftRoom(ServerWorld world, NbtCompound nbt) {
            super(ReplacementFeatureList.MINESHAFT_ROOM, nbt);
            DataResult var10000 = BlockBox.CODEC.listOf().parse(NbtOps.INSTANCE, nbt.getList("Entrances", 11));
            Logger var10001 = CustomMineshaftGenerator.LOGGER;
            Objects.requireNonNull(var10001);
            Optional<List<BlockBox>> var3 = var10000.resultOrPartial(var10001::error);
            List<BlockBox> var4 = this.entrances;
        ...
        public void fillOpenings(StructurePiece start, StructurePiecesHolder structurePiecesHolder, Random random) {
            ...
            int k;
            CustomMineshaftGenerator.MineshaftPart structurePiece;
            BlockBox blockBox4;
            for(k = 0; k < this.boundingBox.getBlockCountX(); k += 4) {
                ...
                structurePiece = CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() + k, this.boundingBox.getMinY() + random.nextInt(j) + 1, this.boundingBox.getMinZ() - 1, Direction.NORTH, i);
            ...
            for(k = 0; k < this.boundingBox.getBlockCountX(); k += 4) {
                ...
                structurePiece = CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() + k, this.boundingBox.getMinY() + random.nextInt(j) + 1, this.boundingBox.getMaxZ() + 1, Direction.SOUTH, i);
                if (structurePiece != null) {
                    blockBox4 = structurePiece.getBoundingBox();
            ...
            for(k = 0; k < this.boundingBox.getBlockCountZ(); k += 4) {
                ...
                structurePiece = CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY() + random.nextInt(j) + 1, this.boundingBox.getMinZ() + k, Direction.WEST, i);
                if (structurePiece != null) {
                    blockBox4 = structurePiece.getBoundingBox();
            ...
            for(k = 0; k < this.boundingBox.getBlockCountZ(); k += 4) {
                ...
                structurePiece = CustomMineshaftGenerator.pieceGenerator(start, structurePiecesHolder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY() + random.nextInt(j) + 1, this.boundingBox.getMinZ() + k, Direction.EAST, i);
                if (structurePiece != null) {
                    blockBox4 = structurePiece.getBoundingBox();
