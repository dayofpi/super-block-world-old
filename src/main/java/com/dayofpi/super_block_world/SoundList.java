...
public class SoundList {
    ...
    protected static final Identifier GOOMBA_IDLE_ID = new Identifier(Main.MOD_ID, "entity.goomba.idle");
    ...
    public static final SoundEvent GOOMBA_IDLE = new SoundEvent(GOOMBA_IDLE_ID);
    public static final SoundEvent GOOMBA_HURT = new SoundEvent(GOOMBA_HURT_ID);
    public static final SoundEvent GOOMBA_DEATH = new SoundEvent(GOOMBA_DEATH_ID);
    public static final SoundEvent BOO_AMBIENT = new SoundEvent(BOO_AMBIENT_ID);
    public static final SoundEvent BOO_HURT = new SoundEvent(BOO_HURT_ID);
    public static final SoundEvent BOO_DEATH = new SoundEvent(BOO_DEATH_ID);
    public static final SoundEvent BOO_SHY = new SoundEvent(BOO_SHY_ID);
    public static final SoundEvent BOO_LAUGH = new SoundEvent(BOO_LAUGH_ID);
    ...
    public static void registerSounds() {
        ...
        Registry.register(Registry.SOUND_EVENT, GOOMBA_IDLE_ID, GOOMBA_IDLE);
        Registry.register(Registry.SOUND_EVENT, GOOMBA_HURT_ID, GOOMBA_HURT);
        Registry.register(Registry.SOUND_EVENT, GOOMBA_DEATH_ID, GOOMBA_DEATH);
