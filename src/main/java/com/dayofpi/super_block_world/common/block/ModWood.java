...
public class ModWood extends PillarBlock {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        BlockState stripResult = BlockReg.STRIPPED_AMANITA_LOG.getDefaultState();
        if (state.isOf(BlockReg.AMANITA_WOOD)) {
            stripResult = BlockReg.STRIPPED_AMANITA_WOOD.getDefaultState();
        }
