package com.dayofpi.super_block_world.common.utility.blocktypes;
...
public class ModSignBase extends AbstractSignBlock {
    public ModSignBase(Settings settings, SignType signType) {
