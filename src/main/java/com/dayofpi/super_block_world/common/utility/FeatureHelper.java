...
import com.dayofpi.super_block_world.common.utility.fluids.CustomLakeFeature;
...
public class FeatureHelper {
    ...
    public static final class States {
        private static final BlockState BROWN_MUSHROOM_CAP = ModBlocks.BROWN_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
        private static final BlockState RED_MUSHROOM_CAP = ModBlocks.RED_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
