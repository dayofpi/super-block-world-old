...
public class Sounds {
    ...
    protected static final Identifier BUZZY_SHELL_EQUIP_ID = new Identifier(Main.MOD_ID, "item.buzzy_shell");
    ...
    public static final SoundEvent BUZZY_SHELL_EQUIP = new SoundEvent(BUZZY_SHELL_EQUIP_ID);
    ...
    public static void registerSounds() {
        ...
        Registry.register(Registry.SOUND_EVENT, BUZZY_SHELL_EQUIP_ID, BUZZY_SHELL_EQUIP);
