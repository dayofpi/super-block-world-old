package com.dayofpi.super_block_world.core.utility.items;

import com.dayofpi.super_block_world.core.Client;
import com.dayofpi.super_block_world.client.SpawnPacket;
import com.dayofpi.super_block_world.core.registry.BlockItems;
...
public class ModBoatEntity extends Entity {
    ...
    public Item asItem() {
        return BlockItems.AMANITA_BOAT;
    }
    ...
    public enum Type {
        AMANITA(BlockReg.AMANITA_PLANKS, "amanita");
