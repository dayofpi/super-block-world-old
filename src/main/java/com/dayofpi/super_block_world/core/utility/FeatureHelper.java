...
import com.dayofpi.super_block_world.core.utility.worldgen.CustomLake;
...
public class FeatureHelper {
    ...
    public static final class States {
        private static final BlockState BROWN_MUSHROOM_CAP = BlockReg.BROWN_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
        private static final BlockState RED_MUSHROOM_CAP = BlockReg.RED_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
