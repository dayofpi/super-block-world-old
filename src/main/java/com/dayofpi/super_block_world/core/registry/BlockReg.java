...
import com.dayofpi.super_block_world.common.block.*;
import com.dayofpi.super_block_world.core.utility.ModSignType;
import com.dayofpi.super_block_world.core.utility.blocktypes.*;
...
public class BlockReg {
    ...
    public static final Block AMANITA_LEAVES = new LeavesBlock(FabricBlockSettings.of(Material.LEAVES).strength(0.2F).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning(BlockReg::canSpawnOnLeaves).suffocates(BlockReg::never).blockVision(BlockReg::never));
    public static final Block FRUITING_AMANITA_LEAVES = new LeavesBlock(FabricBlockSettings.of(Material.LEAVES).strength(0.2F).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning(BlockReg::canSpawnOnLeaves).suffocates(BlockReg::never).blockVision(BlockReg::never));
    ...
    public static void registerBlocks() {
        ...
        Registry.register(Registry.BLOCK, new Identifier(Main.MOD_ID, "amanita_sapling"), ModPlants.AMANITA_SAPLING);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Main.MOD_ID, "yellow_mushroom"), ModPlants.YELLOW_MUSHROOM);
        Registry.register(Registry.BLOCK, new Identifier(Main.MOD_ID, "green_mushroom"), ModPlants.GREEN_MUSHROOM);
        Registry.register(Registry.BLOCK, new Identifier(Main.MOD_ID, "yellow_flowerbed"), ModPlants.YELLOW_FLOWERBED);
