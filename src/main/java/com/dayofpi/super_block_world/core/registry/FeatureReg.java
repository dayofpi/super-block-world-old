...
import com.dayofpi.super_block_world.common.block.MushroomCap;
...
public class FeatureReg {
    public static final ConfiguredFeature<TreeFeatureConfig, ?> AMANITA = Feature.TREE.configure((new TreeFeatureConfig.Builder(
            ...
            new SimpleBlockStateProvider(States.AMANITA_SAPLING), new LargeOakFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().dirtProvider(new SimpleBlockStateProvider(BlockReg.TOADSTOOL_GRASS.getDefaultState())).build());
    ...
    public static final class States {
        private static final BlockState YELLOW_MUSHROOM_CAP = BlockReg.YELLOW_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
        private static final BlockState GREEN_MUSHROOM_CAP = BlockReg.GREEN_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
        private static final BlockState MUSHROOM_STEM = BlockReg.MUSHROOM_STEM.getDefaultState();
        private static final BlockState AMANITA_LEAVES = BlockReg.AMANITA_LEAVES.getDefaultState();
        private static final BlockState FRUITING_AMANITA_LEAVES = BlockReg.FRUITING_AMANITA_LEAVES.getDefaultState();
        private static final BlockState AMANITA_SAPLING = ModPlants.AMANITA_SAPLING.getDefaultState();
        private static final BlockState AMANITA_LOG = BlockReg.AMANITA_LOG.getDefaultState();
    }
}
