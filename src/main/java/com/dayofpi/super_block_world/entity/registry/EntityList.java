...
public class EntityList {
    ...
    public static final EntityType<BobOmbEntity> BOB_OMB = FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, BobOmbEntity::new)
    ...
    public static void registerEntities() {
        ...
        FabricDefaultAttributeRegistry.register(BOB_OMB, BobOmbEntity.createAttributes());
