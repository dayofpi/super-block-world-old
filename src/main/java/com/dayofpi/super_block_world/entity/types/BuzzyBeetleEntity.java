...
public class BuzzyBeetleEntity extends AbstractBuzzy implements ItemSteerable, Saddleable {
    ...
    public void initGoals() {
        ...
        this.goalSelector.add(3, new TemptGoal(this, 1.2D, Ingredient.ofItems(ItemList.GREEN_MUSHROOM_ON_A_STICK), false));
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData, @Nullable NbtCompound entityNbt) {
        if (this.isBaby()) {
            ...
            if (this.random.nextInt(20) == 0 && world.getBlockState(this.getBlockPos().up()).isAir()) {
                BuzzyBeetleEntity passiveEntity = EntityList.BUZZY_BEETLE.create(world.toServerWorld());
