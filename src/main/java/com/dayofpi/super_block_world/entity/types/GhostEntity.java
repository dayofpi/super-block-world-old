...
public class GhostEntity extends Entity {
    ...
    public GhostEntity(EntityType<? extends GhostEntity> type, World world,  double x, double y, double z) {
        super(type, world);
    ...
    public final ActionResult interact(PlayerEntity player, Hand hand) {
        ...
        if (itemStack.isOf(Items.GLASS_BOTTLE)) {
            ...
            ItemStack itemStack2 = ItemUsage.exchangeStack(itemStack, player, ItemList.BOTTLE_O_GHOST.getDefaultStack());
