...
import com.dayofpi.super_block_world.utility.fluids.CustomLakeFeature;
...
public class FeatureHelper {
    ...
    public static final class States {
        private static final BlockState BROWN_MUSHROOM_CAP = BlockRegistry.BROWN_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
        private static final BlockState RED_MUSHROOM_CAP = BlockRegistry.RED_MUSHROOM_CAP.getDefaultState().with(MushroomCap.DOWN, false);
